...
// function getUserId() {
//   return localStorage.getItem("expenseUserId");
// }
...
//       typeFilter === "all"
//         ? allTransactions
//         : allTransactions.filter((item) => item.type === typeFilter);
...
//   } catch {
//     showToast(
//       "Backend not connected. Start server using node server.js",
//       "error",
//     );
//   }
// }
...
//   }
// }
// function getFilteredTransactionsForReport(useFilter) {
//   if (!useFilter) return allTransactions;
...
//   let data = allTransactions.filter((item) => {
//     const typeOk = typeFilter === "all" || item.type === typeFilter;
//     const categoryOk =
//       categoryFilter === "all" || item.category === categoryFilter;
//     const searchOk = item.title.toLowerCase().includes(searchText);
...
//   const printFiltered = confirm(
//     "Do you want to print only filtered transactions?\n\nOK = With Filter\nCancel = All Transactions",
//   );
...
//   const reportData = getFilteredTransactionsForReport(printFiltered);

//   if (reportData.length === 0) {
//     showToast("No transactions found for selected filter", "warning");
//     return;
//   }
...
//             <p><strong>Report Type:</strong> ${printFiltered ? "Filtered Transactions" : "All Transactions"}</p>
//           </div>
//         </div>
...
//         <p class="note">
//           * This report is generated from ${printFiltered ? "currently selected filters" : "all available transactions"} in Finlytics.
//         </p>
